// Enhanced by AI on 2025-08-15T00:22:59.214Z
// Section: footer
// Category: footer
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Streamline your team's workflow and boost productivity with our powerful project management platform. 
                Join thousands of businesses who trust our SaaS solution.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@projectmanager.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">456 Project Ave, Suite 200</span>
              </div>
            </div>
