// Enhanced by AI on 2025-08-15T00:23:10.615Z
// Section: hero
// Category: hero
        ...
        <div className="grid items-center gap-12 py-20 sm:py-24 lg:grid-cols-2 lg:gap-20 lg:py-32">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-muted-foreground">
              Boost your team's productivity with our powerful project management platform. Effortlessly plan, collaborate, and deliver projects on time.
            </p>
