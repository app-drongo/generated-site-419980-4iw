// Enhanced by AI on 2025-08-15T00:22:41.052Z
// Section: cta
// Category: cta
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of successful teams who have chosen our project management
                platform. Start your free trial today and experience the difference.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by leading project management teams
                </p>
